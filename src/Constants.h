...
constexpr uint8_t ROTARY_ENCODERS_PIN[NUMBER_OF_ROTARY_ENCODERS][2] = {{ROTARY_ENCODER_ONE_A, ROTARY_ENCODER_ONE_B},
                                                                       {ROTARY_ENCODER_TWO_A, ROTARY_ENCODER_TWO_B}};
...
char KEY_MATRIX[ROWS][COLS] = {{'A', 'B', 'C', 'D'}, {'E', 'F', 'G', 'H'}, {'I', 'J', 'K', 'L'}, {'M', 'N', 'O', 'P'}};
...
constexpr char constNotesStr[128][6] = {
    "C-1", "C#-1", "D-1", "D#-1", "E-1", "F-1", "F#-1", "G-1", "G#-1", "A-1", "A#-1", "B-1", "C0",  "C#0", "D0",  "D#0",
    "E0",  "F0",   "F#0", "G0",   "G#0", "A0",  "A#0",  "B0",  "C1",   "C#1", "D1",   "D#1", "E1",  "F1",  "F#1", "G1",
    "G#1", "A1",   "A#1", "B1",   "C2",  "C#2", "D2",   "D#2", "E2",   "F2",  "F#2",  "G2",  "G#2", "A2",  "A#2", "B2",
    ...
    "E8",  "F8",   "F#8", "G8",   "G#8", "A8",  "A#8",  "B8",  "C9",   "C#9", "D9",   "D#9", "E9",  "F9",  "F#9", "G9"};

constexpr uint32_t constNotesFreq[128] = {
    8175,    8661,    9177,    9722,    10300,   10913,   11562,   12249,   12978,   13750,   14567,   15434,
    16351,   17323,   18354,   19445,   20601,   21827,   23124,   24499,   25956,   27500,   29135,   30867,
    32703,   34647,   36708,   38890,   41203,   43654,   46249,   48999,   51913,   55000,   58270,   61735,
    65406,   69295,   73416,   77781,   82406,   87307,   92498,   97999,   103826,  110000,  116540,  123470,
    ...
    523251,  554365,  587329,  622253,  659255,  698456,  739988,  783990,  830609,  880000,  932327,  987766,
    1046502, 1108730, 1174658, 1244507, 1318510, 1396913, 1479977, 1567980, 1661218, 1760000, 1864655, 1975533,
    2093004, 2217461, 2349317, 2489015, 2637020, 2793826, 2959955, 3135960, 3322437, 3520000, 3729310, 3951066,
    4186009, 4434922, 4698635, 4978031, 5274041, 5587652, 5919911, 6271920, 6644875, 7040000, 7458620, 7902132};
}; // namespace Constants
