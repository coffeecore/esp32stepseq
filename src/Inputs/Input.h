...
public:
    ...
    Input(Sequencer::Sequencer& _sequencer, InputEngine& _inputEngine, RotaryEncoder& _rotaryEncoders)
        : sequencer(_sequencer)
        , pad(makeKeymap(Constants::KEY_MATRIX), Constants::ROWS_PINS, Constants::COLS_PINS,
    ...
    void begin()
    {
        ...
        xTaskCreatePinnedToCore(inputTask, "InputTask", 8192, this, 1, &xHandleInput, 0);

        xTaskCreatePinnedToCore(inputManagerTask, "InputManagerTask", 8192, this, 1, &xHandleInputManager, 0);
    }
