...
public:
    ...
    void applyEncoderMapping() override
    {
        ...
        layerContext.rotaryEncoders.setEncoderBoundaries(ControlId::Encoder0, 0, Constants::NUMBER_OF_INSTRUMENTS - 1,
                                                         false);

        layerContext.rotaryEncoders.setEncoderBoundaries(ControlId::Encoder1, 0, Constants::NUMBER_OF_INSTRUMENTS - 1,
                                                         false);
    }
