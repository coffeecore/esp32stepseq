...
public:
    ...
    void begin()
    {
        ...
        for (uint8_t i = 0; i < Constants::NUMBER_OF_ROTARY_ENCODERS; i++) {
            rotaryEncoders[i] = new AiEsp32RotaryEncoder(Constants::ROTARY_ENCODERS_PIN[i][0],
                                                         Constants::ROTARY_ENCODERS_PIN[i][1], -1, -1, 4);
                              ...
                              uint8_t acceleration = 0)
    {
        ...
        rotaryEncoders[idx]->setAcceleration(acceleration);
    }
    ...
    {
        switch (encoder) {
            case ControlId::Encoder0:
                return 0;
            case ControlId::Encoder1:
                return 1;
            default:
                return -1;
        }
