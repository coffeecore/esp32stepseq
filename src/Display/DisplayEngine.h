...
#include "Screens/SequencerScreen.h"
#include "Screens/InstrumentMenuScreen.h"
#include "Screens/InstrumentAdsrScreen.h"
...
public:
    ...
    Screens::SequencerScreen sequencerScreen;
    Screens::InstrumentMenuScreen instrumentMenuScreen;
    Screens::InstrumentAdsrScreen instrumentAdsrScreen;
    Screens::Screen* currentScreen = nullptr;
    TaskHandle_t taskHandle = nullptr;

    explicit DisplayEngine(U8G2& u8g2, UIState& uiState, Sequencer::Sequencer& seq, IAudioEngine& audioEngine,
    ...
    void resolveScreen()
    {
        Screens::Screen* nextScreen = nullptr;
    ...
    void begin()
    {
        xTaskCreatePinnedToCore(taskLoop, "DisplayTask", 8192, this, 1, &taskHandle, 0);
