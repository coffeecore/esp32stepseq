...
{
    // --- Menu configuration ---
    constexpr EnumOption sourceOptions[] = {{static_cast<int8_t>(InstrumentSource::Wave), "Wave"}, {static_cast<int8_t>(InstrumentSource::Sample), "Sample"}};
    constexpr EnumDescriptor sourceDescriptor(sourceOptions, Constants::countof(sourceOptions));

    constexpr EnumOption waveTypeOptions[] = {
        {static_cast<int8_t>(WaveType::WAVE_NOISE), "Noise"},       {static_cast<int8_t>(WaveType::WAVE_PULSE), "Pulse"},
        {static_cast<int8_t>(WaveType::WAVE_SAW), "Saw"},           {static_cast<int8_t>(WaveType::WAVE_SINE), "Sine"},
        {static_cast<int8_t>(WaveType::WAVE_TRIANGLE), "Triangle"},
    };
    constexpr EnumDescriptor waveTypeDescriptor(waveTypeOptions, Constants::countof(waveTypeOptions));

    constexpr EnumOption loopOptions[] = {{static_cast<int8_t>(LoopMode::LOOP_OFF), "Off"},
    ...
    constexpr EnumDescriptor loopDescriptor(loopOptions, Constants::countof(loopOptions));
    ...
    public:
        ...
        void onExit(UIOverlay overlay) override
        {
            ...
            audioEngine.updateInstrument(uiState.selectedInstrument, instrument);
        }
