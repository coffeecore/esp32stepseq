...
union MenuValue {
    ...
    constexpr MenuValue(bool* v)
        : boolean(v)
    {
    }

    constexpr MenuValue(int32_t* v)
        : integer(v)
    {
    }

    constexpr MenuValue(float* v)
        : floating(v)
    {
    }

    constexpr MenuValue(int8_t* v)
        : enumeration(v)
    {
    }
};
...
struct MenuDescriptor
{
    ...
    constexpr explicit MenuDescriptor(MenuType t)
        : type(t)
    {
    }
