...
#include "Input/Layer/InstrumentAdsrLayerGroup.h"
...
class InputEngine
{
    public:
        ...
        InstrumentAdsrLayerGroup instrumentAdsrLayerGroup;
        ...
        explicit InputEngine(Sequencer& _sequencer, RotaryEncoder& _rotaryEncoders, UIState& _ui, MenuManager& _menuManager, IAudioEngine& audioEngine)
            :
            ui(_ui),
            layerContext(_sequencer, _rotaryEncoders, _menuManager, audioEngine),
            sequencer(_sequencer),
            rotaryEncoders(_rotaryEncoders),
            mainLayerGroup(ctx, layerContext, ui),
            menuLayerGroup(ctx, layerContext, ui),
            instrumentAdsrLayerGroup(ctx, layerContext, ui)
        {
        }
        ...
        void resolveLayerGroup()
        {
            ...
            switch (ui.workspace)
            {
                ...
                case Workspace::InstrumentAdsr:
                    currentLayerGroup = &instrumentAdsrLayerGroup;
